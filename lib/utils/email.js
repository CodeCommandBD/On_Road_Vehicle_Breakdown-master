 ...
 * @param {Object} options - Email options (to, subject, html, text, etc.)
 */
export async function sendEmail(options) {
  const mailOptions = {
    from: `"On-Road Vehicle Breakdown" <${process.env.EMAIL_USER}>`,
    ...options,
  };
 ...
 */
export async function sendNewsletterConfirmation(to) {
  const mailOptions = {
    from: `"On-Road Vehicle Breakdown" <${process.env.EMAIL_USER}>`,
    to: to,
      ...
      <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 600px; margin: 0 auto; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 30px; border-radius: 15px;">
        <div style="background: white; padding: 40px; border-radius: 10px; box-shadow: 0 10px 30px rgba(0,0,0,0.2);">
          ...
          <div style="text-align: center; margin-bottom: 30px;">
            <h1 style="color: #667eea; font-size: 32px; margin: 0;">🎉 Welcome!</h1>
            <p style="color: #666; font-size: 16px; margin: 10px 0;">You're now part of our community</p>
          </div>
          ...
          <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 20px; border-radius: 10px; text-align: center; margin: 25px 0;">
            ...
            <p style="margin: 10px 0 0 0; opacity: 0.9;">You've successfully subscribed to our newsletter</p>
          </div>

          <!-- What to Expect -->
          <div style="margin: 30px 0;">
            <h3 style="color: #333; border-bottom: 2px solid #667eea; padding-bottom: 10px;">📬 What to Expect</h3>
            
            <div style="margin: 20px 0;">
              <div style="display: flex; align-items: start; margin: 15px 0;">
                <span style="font-size: 24px; margin-right: 15px;">🚗</span>
                <div>
                  <strong style="color: #333;">Latest Updates</strong>
                  <p style="margin: 5px 0; color: #666; font-size: 14px;">Get the latest news about vehicle breakdown services and tips</p>
                </div>
              </div>
              ...
              <div style="display: flex; align-items: start; margin: 15px 0;">
                <span style="font-size: 24px; margin-right: 15px;">💡</span>
                <div>
                  <strong style="color: #333;">Expert Tips</strong>
                  <p style="margin: 5px 0; color: #666; font-size: 14px;">Receive helpful maintenance tips and safety advice</p>
                </div>
              </div>
              ...
              <div style="display: flex; align-items: start; margin: 15px 0;">
                <span style="font-size: 24px; margin-right: 15px;">🎁</span>
                <div>
                  <strong style="color: #333;">Exclusive Offers</strong>
                  <p style="margin: 5px 0; color: #666; font-size: 14px;">Be the first to know about special promotions and discounts</p>
                </div>
              </div>
              ...
              <div style="display: flex; align-items: start; margin: 15px 0;">
                <span style="font-size: 24px; margin-right: 15px;">📢</span>
                <div>
                  <strong style="color: #333;">Important Announcements</strong>
                  <p style="margin: 5px 0; color: #666; font-size: 14px;">Stay informed about new features and service updates</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div style="text-align: center; margin: 30px 0;">
            <a href="${
              process.env.NEXT_PUBLIC_APP_URL
            }" style="display: inline-block; background: #667eea; color: white; padding: 15px 30px; text-decoration: none; border-radius: 8px; font-weight: bold; font-size: 16px; margin: 5px;">
              🏠 Visit Our Website
            </a>
            <a href="${
              process.env.NEXT_PUBLIC_APP_URL
            }/services" style="display: inline-block; background: #28a745; color: white; padding: 15px 30px; text-decoration: none; border-radius: 8px; font-weight: bold; font-size: 16px; margin: 5px;">
              🔧 Explore Services
            </a>
          </div>

          <!-- Info Box -->
          <div style="background: #f8f9fa; border-left: 4px solid #667eea; padding: 15px; margin: 25px 0; border-radius: 5px;">
            <p style="margin: 0; color: #333; font-size: 14px;">
              <strong>📧 Email Frequency:</strong> We'll send you updates 1-2 times per week. No spam, we promise!
            </p>
          </div>
          ...
          <div style="background: #fff3cd; border-left: 4px solid #ffc107; padding: 15px; margin: 20px 0; border-radius: 5px;">
            <p style="margin: 0; color: #856404; font-size: 13px;">
              <strong>Want to unsubscribe?</strong> No problem! You can unsubscribe at any time by clicking the unsubscribe link in any of our emails.
            </p>
          </div>

          <!-- Social Media -->
          <div style="text-align: center; margin: 30px 0; padding: 20px; background: #f8f9fa; border-radius: 8px;">
            <p style="margin: 0 0 15px 0; color: #666; font-weight: bold;">Follow us on social media:</p>
            <div style="display: inline-block;">
              <a href="#" style="display: inline-block; margin: 0 10px; text-decoration: none; font-size: 24px;">📘</a>
              <a href="#" style="display: inline-block; margin: 0 10px; text-decoration: none; font-size: 24px;">🐦</a>
              <a href="#" style="display: inline-block; margin: 0 10px; text-decoration: none; font-size: 24px;">📷</a>
              <a href="#" style="display: inline-block; margin: 0 10px; text-decoration: none; font-size: 24px;">💼</a>
            </div>
          ...
          <p style="color: #666; font-size: 12px; text-align: center; margin: 0;">
            Thank you for subscribing to On-Road Vehicle Breakdown Newsletter!<br/>
            This email was sent to <strong>${to}</strong><br/>
            <br/>
            © ${new Date().getFullYear()} On-Road Vehicle Breakdown. All rights reserved.
          </p>
        </div>
      </div>
    `,
