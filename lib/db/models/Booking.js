...
const bookingSchema = new mongoose.Schema(
  {
    ...
    paymentDetails: {
      ...
      method: {
        type: String,
        enum: ["cash", "bkash", "nagad", "card", "sslcommerz"],
      },
      submittedAt: Date,
      approvedAt: Date,
      approvedBy: {
    ...
    // OTP for service completion verification
    completionOTP: {
      code: {
        type: String,
        default: null,
...
// Virtual for JobCard
bookingSchema.virtual("jobCard", {
  ref: "JobCard",
  localField: "_id",
  foreignField: "booking", // MATCHES JobCard Schema field name
  justOne: true,
});
