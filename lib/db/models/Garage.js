    ...
    teamMembers: [
      {
        ...
        email: String,
        phone: String,
        initialPassword: { type: String, select: true }, // To show password to garage owner
        role: {
          type: String,
...
// Force re-compile model to pick up schema changes
if (mongoose.models.Garage) {
  delete mongoose.models.Garage;
}
