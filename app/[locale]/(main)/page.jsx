...
const servicesData = {
  cars: [
    {
      icon: "/images/nav/nav-one.png",
      title: "Windshields",
      link: "/services",
    },
    { icon: "/images/nav/nav-two.png", title: "Door", link: "/services" },
    {
      icon: "/images/nav/nav-three.png",
      title: "Air Condition",
      link: "/services",
    },
    ...
    {
      icon: "/images/nav/nav-seven.png",
      title: "Oil Change",
      link: "/services",
    },
    {
      icon: "/images/nav/nav-eight.png",
      title: "Suspension",
      link: "/services",
    },
  ],
...
const testimonials = [
  {
    ...
    role: "Truck Driver",
    rating: 5,
    text: "Fast, trustworthy and affordable!",
  ...
  },
  {
    ...
    role: "Car Owner",
    rating: 5,
    text: "Membership pays for itself.",
  ...
  },
  {
    ...
    role: "Fleet Manager",
    rating: 5,
    text: "Reliable partner for our fleet.",
