...
import RepairService from './RepairService.vue'
import ServicePackage from './ServicePackage.vue'
import TopGarage from './TopGarage.vue'
import RoadFooter from './RoadFooter.vue'

export default {
  name:'HeroArea',
  components: { RepairService, ServicePackage, TopGarage, RoadFooter },
  data() {
    return {
      slides: [
        {
